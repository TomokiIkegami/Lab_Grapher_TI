...
ax.set_xlabel("{0} {1} [{2}{3}".format(x_label[0], get_greek(x_label[1]), aux_unit_x, x_unit[cur_x:]), fontsize=12,
              fontname="Times New Roman")    # 軸ラベルを英語で入力。$マークに挟まれている範囲は数式が入力可能。ここでもフォントサイズの設定が可能。
ax.set_ylabel("{0} {1} [{2}{3}".format(y_label[0][0], get_greek(y_label[0][1]), aux_unit_y, y_unit[0][cur_y:]), fontsize=12,
              fontname="Times New Roman")  # 軸ラベルを英語で入力。$マークに挟まれている範囲は数式が入力可能。ここでもフォントサイズの設定が可能。
